...
{
	DrawExtendGraph(0, 0, Game::kScreenWidht, Game::kScreenHeight, m_bgHandle, false);
	DrawGraph(Game::kScreenWidht / 2 - m_graphWidth / 2,
		Game::kScreenHeight / 2 - m_graphHeight / 2,
